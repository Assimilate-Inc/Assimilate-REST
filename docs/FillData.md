...
**blend_mode** | **str** | Blend mode of the fill | [optional] 
**blur** | **float** | Amount of blur to apply to the fill | [optional] 
**blur_angle** | **float** | Angle of the blur to apply to the fill | [optional] 
