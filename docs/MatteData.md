...
**blend_mode** | **str** | Blend mode of the matte | [optional] 
**blur** | **float** | Amount of blur to apply to the matte | [optional] 
**blur_angle** | **float** | Angle of the blur to apply to the matte | [optional] 
...
**warp_equi_dist** | **float** | Warp equi distance | [optional] 
