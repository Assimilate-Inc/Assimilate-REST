...
[**add_shot_layer**](ProjectsApi.md#add_shot_layer) | **POST** /shot/{shot_uuid}/layers/new | Shot Create Layer
[**add_shot_layer_group**](ProjectsApi.md#add_shot_layer_group) | **POST** /shot/{shot_uuid}/layers/group | Shot Create Layer Group
[**delete_construct**](ProjectsApi.md#delete_construct) | **DELETE** /constructs/{construct_uuid} | Construct Delete
[**delete_construct_current_output**](ProjectsApi.md#delete_construct_current_output) | **DELETE** /constructs/current/outputs/{output_uuid} | Output Delete (CC)
...
[**delete_construct_output**](ProjectsApi.md#delete_construct_output) | **DELETE** /constructs/{construct_uuid}/outputs/{output_uuid} | Output Delete (CID)
...
[**delete_shot_input**](ProjectsApi.md#delete_shot_input) | **DELETE** /shot/{shot_uuid}/inputs/{input_idx} | Input Delete
[**delete_shot_layer**](ProjectsApi.md#delete_shot_layer) | **DELETE** /shot/{shot_uuid}/layers/{layer_idx} | Shot Delete Layer
[**get_construct**](ProjectsApi.md#get_construct) | **GET** /constructs/{construct_uuid} | Construct Get Properties
[**get_construct_current_output**](ProjectsApi.md#get_construct_current_output) | **GET** /constructs/current/outputs/{output_uuid} | Output Get Properties (CC)
...
[**get_construct_output**](ProjectsApi.md#get_construct_output) | **GET** /constructs/{construct_uuid}/outputs/{output_uuid} | Output Get Properties (CID)
...
[**get_shot_layer_canvas**](ProjectsApi.md#get_shot_layer_canvas) | **GET** /shot/{shot_uuid}/layers/{layer_idx}/canvas | Shot Layer Get Canvas Properties
[**get_shot_layer_color**](ProjectsApi.md#get_shot_layer_color) | **GET** /shot/{shot_uuid}/layers/{layer_idx}/color | Shot Layer Get Color Properties
[**get_shot_layer_fill**](ProjectsApi.md#get_shot_layer_fill) | **GET** /shot/{shot_uuid}/layers/{layer_idx}/fill | Shot Layer Get Fill Properties
[**get_shot_layer_matte**](ProjectsApi.md#get_shot_layer_matte) | **GET** /shot/{shot_uuid}/layers/{layer_idx}/matte | Shot Layer Get Matte Properties
[**get_shot_layers**](ProjectsApi.md#get_shot_layers) | **GET** /shot/{shot_uuid}/layers | Shot Get Layers Properties
...
[**reset_shot_layer_matte**](ProjectsApi.md#reset_shot_layer_matte) | **DELETE** /shot/{shot_uuid}/layers/{layer_idx}/matte | Shot Layer Reset Matte Properties
...
[**set_construct_current_output**](ProjectsApi.md#set_construct_current_output) | **PUT** /constructs/current/outputs/{output_uuid} | Output Set Properties (CC)
...
[**set_construct_output**](ProjectsApi.md#set_construct_output) | **PUT** /constructs/{construct_uuid}/outputs/{output_uuid} | Output Set Properties (CID)
...
[**set_shot_layer_color**](ProjectsApi.md#set_shot_layer_color) | **PUT** /shot/{shot_uuid}/layers/{layer_idx}/color | Shot Layer Set  Color Properties
[**set_shot_layer_fill**](ProjectsApi.md#set_shot_layer_fill) | **PUT** /shot/{shot_uuid}/layers/{layer_idx}/fill | Shot Layer Set  Fill Properties
[**set_shot_layer_matte**](ProjectsApi.md#set_shot_layer_matte) | **PUT** /shot/{shot_uuid}/layers/{layer_idx}/matte | Shot Layer Set  Matte Properties
...
# **add_shot_layer**
> LayerData add_shot_layer(body, shot_uuid, level=level)
...
try:
    # Shot Create Layer
    api_response = api_instance.add_shot_layer(body, shot_uuid, level=level)
    pprint(api_response)
except ApiException as e:
...
> add_shot_layer_group(shot_uuid, body=body, level=level)
...
try:
    # Shot Create Layer Group
    api_instance.add_shot_layer_group(shot_uuid, body=body, level=level)
except ApiException as e:
...
> delete_construct_current_output(output_uuid)
...
try:
    # Output Delete (CC)
    api_instance.delete_construct_current_output(output_uuid)
except ApiException as e:
...
> delete_construct_output(construct_uuid, output_uuid)
...
try:
    # Output Delete (CID)
    api_instance.delete_construct_output(construct_uuid, output_uuid)
except ApiException as e:
...
try:
    # Shot Delete
    api_instance.delete_shot(shot_uuid)
except ApiException as e:
...
# **delete_shot_input**
> delete_shot_input(shot_uuid, input_idx)
...
try:
    # Input Delete
    api_instance.delete_shot_input(shot_uuid, input_idx)
except ApiException as e:
...
# **delete_shot_layer**
> delete_shot_layer(shot_uuid, layer_idx)
...
try:
    # Shot Delete Layer
    api_instance.delete_shot_layer(shot_uuid, layer_idx)
except ApiException as e:
...
> ShotData get_construct_current_output(output_uuid, level=level)
...
try:
    # Output Get Properties (CC)
    api_response = api_instance.get_construct_current_output(output_uuid, level=level)
    pprint(api_response)
except ApiException as e:
...
> ShotData get_construct_output(construct_uuid, output_uuid, level=level)
...
try:
    # Output Get Properties (CID)
    api_response = api_instance.get_construct_output(construct_uuid, output_uuid, level=level)
    pprint(api_response)
except ApiException as e:
...
# **get_shot**
> ShotData get_shot(shot_uuid, level=level)
...
try:
    # Shot Get Properties
    api_response = api_instance.get_shot(shot_uuid, level=level)
    pprint(api_response)
except ApiException as e:
...
# **get_shot_color**
> ColorgradeData get_shot_color(shot_uuid, level=level)
...
try:
    # Shot Get Color Properties
    api_response = api_instance.get_shot_color(shot_uuid, level=level)
    pprint(api_response)
except ApiException as e:
...
try:
    ...
    print("Exception when calling ProjectsApi->get_shot_controls: %s\n" % e)
```
...
# **get_shot_input**
> InputData get_shot_input(shot_uuid, input_idx)
...
try:
    # Input Get Properties
    api_response = api_instance.get_shot_input(shot_uuid, input_idx)
    pprint(api_response)
except ApiException as e:
...
# **get_shot_inputs**
> InputsData get_shot_inputs(shot_uuid)
...
try:
    # Inputs List
    api_response = api_instance.get_shot_inputs(shot_uuid)
    pprint(api_response)
except ApiException as e:
...
# **get_shot_layer**
> LayerData get_shot_layer(shot_uuid, layer_idx, level=level)
...
try:
    # Shot Get Layer Properties
    api_response = api_instance.get_shot_layer(shot_uuid, layer_idx, level=level)
    pprint(api_response)
except ApiException as e:
...
> CanvasData get_shot_layer_canvas(shot_uuid, layer_idx, level=level)
...
try:
    # Shot Layer Get Canvas Properties
    api_response = api_instance.get_shot_layer_canvas(shot_uuid, layer_idx, level=level)
    pprint(api_response)
except ApiException as e:
...
> ColorgradeData get_shot_layer_color(shot_uuid, layer_idx, level=level)
...
try:
    # Shot Layer Get Color Properties
    api_response = api_instance.get_shot_layer_color(shot_uuid, layer_idx, level=level)
    pprint(api_response)
except ApiException as e:
...
# **get_shot_layer_fill**
> FillData get_shot_layer_fill(shot_uuid, layer_idx, level=level)
...
try:
    # Shot Layer Get Fill Properties
    api_response = api_instance.get_shot_layer_fill(shot_uuid, layer_idx, level=level)
    pprint(api_response)
except ApiException as e:
...
> MatteData get_shot_layer_matte(shot_uuid, layer_idx, level=level)
...
try:
    # Shot Layer Get Matte Properties
    api_response = api_instance.get_shot_layer_matte(shot_uuid, layer_idx, level=level)
    pprint(api_response)
except ApiException as e:
...
# **get_shot_layers**
> LayersData get_shot_layers(shot_uuid, level=level)
...
try:
    # Shot Get Layers Properties
    api_response = api_instance.get_shot_layers(shot_uuid, level=level)
    pprint(api_response)
except ApiException as e:
...
# **move_layer**
> move_layer(body, shot_uuid, layer_idx)
...
try:
    # Layer Move
    api_instance.move_layer(body, shot_uuid, layer_idx)
except ApiException as e:
...
# **move_shot**
> move_shot(body, shot_uuid, level=level)
...
try:
    # Shot Move
    api_instance.move_shot(body, shot_uuid, level=level)
except ApiException as e:
...
try:
    # Shot Reset Color Properties
    api_instance.reset_shot_color(shot_uuid)
except ApiException as e:
    print("Exception when calling ProjectsApi->reset_shot_color: %s\n" % e)
```
...
try:
    ...
    print("Exception when calling ProjectsApi->reset_shot_controls: %s\n" % e)
```
...
> reset_shot_layer_canvas(shot_uuid, layer_idx)
...
try:
    # Shot Layer Reset Canvas Properties
    api_instance.reset_shot_layer_canvas(shot_uuid, layer_idx)
except ApiException as e:
...
> reset_shot_layer_color(shot_uuid, layer_idx)
...
try:
    # Shot Layer Reset Color Properties
    api_instance.reset_shot_layer_color(shot_uuid, layer_idx)
except ApiException as e:
...
> reset_shot_layer_fill(shot_uuid, layer_idx)
...
try:
    # Shot Layer Reset Fill Properties
    api_instance.reset_shot_layer_fill(shot_uuid, layer_idx)
except ApiException as e:
...
> reset_shot_layer_matte(shot_uuid, layer_idx)
...
try:
    # Shot Layer Reset Matte Properties
    api_instance.reset_shot_layer_matte(shot_uuid, layer_idx)
except ApiException as e:
...
> ShotData set_construct_current_output(body, output_uuid, level=level)
...
try:
    # Output Set Properties (CC)
    api_response = api_instance.set_construct_current_output(body, output_uuid, level=level)
    pprint(api_response)
except ApiException as e:
...
> ShotData set_construct_output(body, construct_uuid, output_uuid, level=level)
...
try:
    # Output Set Properties (CID)
    api_response = api_instance.set_construct_output(body, construct_uuid, output_uuid, level=level)
    pprint(api_response)
except ApiException as e:
...
# **set_shot**
> ShotData set_shot(body, shot_uuid, level=level)
...
try:
    # Shot Set Properties
    api_response = api_instance.set_shot(body, shot_uuid, level=level)
    pprint(api_response)
except ApiException as e:
...
# **set_shot_color**
> ColorgradeData set_shot_color(body, shot_uuid, level=level)
...
try:
    # Shot Set Color Properties
    api_response = api_instance.set_shot_color(body, shot_uuid, level=level)
    pprint(api_response)
except ApiException as e:
...
# create an instance of the API class
api_instance = assimilate_client.ProjectsApi()
body = assimilate_client.ControlsData() # ControlsData | json with shot data
shot_uuid = assimilate_client.Uuid() # Uuid | Shot UUID
level = 'level_example' # str | Level of detail. If set to ALL the full data model is returned. (optional)
...
try:
    ...
    print("Exception when calling ProjectsApi->set_shot_controls: %s\n" % e)
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **body** | [**ControlsData**](ControlsData.md)| json with shot data | 
 **shot_uuid** | [**Uuid**](.md)| Shot UUID | 
 **level** | **str**| Level of detail. If set to ALL the full data model is returned. | [optional] 
...
# **set_shot_input**
> InputData set_shot_input(body, shot_uuid, input_idx)
...
# create an instance of the API class
api_instance = assimilate_client.ProjectsApi()
body = assimilate_client.InputData() # InputData | json with input settings
shot_uuid = assimilate_client.Uuid() # Uuid | Shot UUID
input_idx = 56 # int | index of the nth input

try:
    # Input Set Properties
    api_response = api_instance.set_shot_input(body, shot_uuid, input_idx)
    pprint(api_response)
except ApiException as e:
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **body** | [**InputData**](InputData.md)| json with input settings | 
 **shot_uuid** | [**Uuid**](.md)| Shot UUID | 
 **input_idx** | **int**| index of the nth input | 
...
# **set_shot_layer**
> LayerData set_shot_layer(body, shot_uuid, layer_idx, level=level)
...
try:
    # Shot Set Layer Properties
    api_response = api_instance.set_shot_layer(body, shot_uuid, layer_idx, level=level)
    pprint(api_response)
except ApiException as e:
...
> CanvasData set_shot_layer_canvas(body, shot_uuid, layer_idx, level=level)
...
try:
    # Shot Layer Set  Canvas Properties
    api_response = api_instance.set_shot_layer_canvas(body, shot_uuid, layer_idx, level=level)
    pprint(api_response)
except ApiException as e:
...
> ColorgradeData set_shot_layer_color(body, shot_uuid, layer_idx, level=level)
...
try:
    # Shot Layer Set  Color Properties
    api_response = api_instance.set_shot_layer_color(body, shot_uuid, layer_idx, level=level)
    pprint(api_response)
except ApiException as e:
...
# **set_shot_layer_fill**
> FillData set_shot_layer_fill(body, shot_uuid, layer_idx, level=level)
...
try:
    # Shot Layer Set  Fill Properties
    api_response = api_instance.set_shot_layer_fill(body, shot_uuid, layer_idx, level=level)
    pprint(api_response)
except ApiException as e:
...
> MatteData set_shot_layer_matte(body, shot_uuid, layer_idx, level=level)
...
try:
    # Shot Layer Set  Matte Properties
    api_response = api_instance.set_shot_layer_matte(body, shot_uuid, layer_idx, level=level)
    pprint(api_response)
except ApiException as e:
